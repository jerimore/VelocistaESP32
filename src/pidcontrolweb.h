...
void guardarPIDenEEPROM() {
    EEPROM.begin(64); // Asegúrate de tener suficiente espacio
        ...
        <div class="card">
          <form method="POST" action="/pid">
            <div class="slider-container">
              ...
              <input type="range" id="kp" name="kp" min="0" max="1" step="0.0001" value=")" + String(Kp, 4) + R"(" oninput="kp_val.innerText=this.value">
              <div class="value">Valor: <span id="kp_val">)" + String(Kp, 4) + R"(</span></div>
            </div>
            <div class="slider-container">
              <label for="ki">Ki</label>
              <input type="range" id="ki" name="ki" min="0" max="0.01" step="0.0001" value=")" + String(Ki, 4) + R"(" oninput="ki_val.innerText=this.value">
              <div class="value">Valor: <span id="ki_val">)" + String(Ki, 4) + R"(</span></div>
            </div>
            <div class="slider-container">
              <label for="kd">Kd</label>
              <input type="range" id="kd" name="kd" min="0" max="1" step="0.001" value=")" + String(Kd, 4) + R"(" oninput="kd_val.innerText=this.value">
              <div class="value">Valor: <span id="kd_val">)" + String(Kd, 4) + R"(</span></div>
            </div>
            <div class="slider-container">
              <label for="kv">Kv</label>
              <input type="range" id="kv" name="kv" min="0" max="0.2" step="0.0001" value=")" + String(kv, 4) + R"(" oninput="kv_val.innerText=this.value">
              <div class="value">Valor: <span id="kv_val">)" + String(kv, 4) + R"(</span></div>
            </div>
...
void handlePID() {
    ...
    guardarPIDenEEPROM(); // <-- Guarda los valores
